...
namespace Drupal\paraseed_media\Plugin\Field\FieldFormatter;
...
/**
 * Plugin implementation of the 'oembed' formatter for Paraseed.
 *
 * @internal
 *   This is an internal part of the oEmbed system and should only be used by
 *   oEmbed-related code in Paraseed.
 *
 * @FieldFormatter(
 *   id = "paraseed_oembed",
 *   label = @Translation("Paraseed oEmbed content"),
 *   field_types = {
 *     "link",
 *     "string",
 *     "string_long",
 ...
 * )
 */
class ParaseedOEmbedFormatter extends OEmbedFormatter {
