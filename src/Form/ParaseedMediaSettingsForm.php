...
namespace Drupal\paraseed_media\Form;
...
/**
 * Provides form for managing Paraseed Media settings form.
 */
class ParaseedMediaSettingsForm extends ConfigFormBase {
  ...
  /**
   * Constructs a new Paraseed Media settings form.
   *
  ...
  public function getFormId() {
    return 'paraseed_media_settings';
  }
  ...
  protected function getEditableConfigNames() {
    return ['paraseed_media.settings'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('paraseed_media.settings');
    ...
    $form['use_blazy_blurry'] = [
      ...
      '#description' => $this->t('Paraseed uses Blazy to lazy-load offscreen images. This setting enhances Paraseed to lazy-load images with a low-res blurred image effect. Switching this setting off (<em>not recommended</em>) will fallback to Blazy pixel loader as configured in <a href="@blazy_settings_link">Blazy UI</a> Note that you’ll need to enable Blazy UI module to configure it.', ['@blazy_settings_link' => $blazy_settings_link]),
